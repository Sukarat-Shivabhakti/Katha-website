...
from .views.main_view import index_method, add_post_method, profile_method, full_article_method, edit_post_method, delete_post_method, profile_method, about_method, privacy_method, terms_method
